...
export default function EducationInfo({ formData, setFormData }) {
  ...
  const [educationList, setEducationList] = useState([
    {
      id:uid, school:"", degree: "", startDate: "", endDate: "", location: "", collapsed: false
    }
  ]);
  ...
  function handleAddEducation() {
    setEducationList([
      ...educationList,
      { id:uid, school: "", degree: "", startDate: "", endDate: "", location: "", collapsed:true}
    ]);
  }
        ...
        {isFormCollapsed ? (
          ...
          <div className="flex items-center justify-between w-full p-4 border rounded-xl bg-gray-50">
            <div className="text-left">
              <p className="text-lg font-semibold text-gray-800">{school}</p>
            </div>
            <div className="flex space-x-4 text-blue-600 cursor-pointer">
              <FaEdit size={22} onClick={() => setIsFormCollapsed(false)} />
              <MdDelete size={22} color="red" />
            </div>
          </div>
          <div className="flex space-x-5 items-center justify-center w-full border rounded-xl cursor-pointer mt-5">
              <FaPlusCircle /> Education
          </div>
          </>
